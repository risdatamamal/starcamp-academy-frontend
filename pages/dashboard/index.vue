    ...
    <section class="container mx-auto pt-8">
      <div class="flex justify-between items-center mb-6">
        ...
        <div class="w-1/4 text-right">
          <nuxt-link
            to="/dashboard/create"
            class="bg-orange-button hover:bg-green-button text-white font-bold py-4 px-4 inline-flex items-center rounded-full"
          >
            + Create Campaign
          </nuxt-link>
        </div>
          ...
          >
            ...
            <div class="flex items-center">
              <nuxt-link
                ...
                class="bg-green-button text-white py-2 px-4 rounded-full"
              >
                Detail
              </nuxt-link>
            </div>
...
export default {
  layout: 'default',
  components: { CallToAction, Footer, Navbar },
  head: {
    title: 'Dashboard',
  },
}
